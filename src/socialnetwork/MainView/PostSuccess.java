...
/**
 * Una clase para representar la interfaz de realizar un post exitoso
 * 
 */
public class PostSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Publicacion realizada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
