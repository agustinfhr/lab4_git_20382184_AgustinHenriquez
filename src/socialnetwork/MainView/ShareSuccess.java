...
/**
 * Una clase para representar la interfaz de realizar un share exitoso
 * 
 */
public class ShareSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Publicacion compartida!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShareSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
