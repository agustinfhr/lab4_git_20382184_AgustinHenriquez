...
/**
 * Una clase para representar la interfaz de un like realizado con exito
 * 
 */
public class LikeSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Me Gusta realizado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LikeSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
