...
/**
 * Una clase para representar la interfaz de comentario realizado con exito
 * 
 */
public class CommentSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Comentario realizado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CommentSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
