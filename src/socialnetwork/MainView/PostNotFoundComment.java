...
/**
 * Una clase para representar la interfaz de un error en el comment, la publicacion a comentar no se encuentra registrada 
 * 
 */
public class PostNotFoundComment extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    
    public PostNotFoundComment() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Error, Publicacion no registrada!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostNotFoundComment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    class FondoPanel extends JPanel {
        ...
        public void paint(Graphics g){
            ...
            imagen = new ImageIcon(getClass().getResource("/imagenes/loginNotFound.jpg")).getImage(); 
