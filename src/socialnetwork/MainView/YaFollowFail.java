...
/**
 * Una clase para representar la interfaz de un error en el follow, usuario ya sigue a ese usuario actual 
 * 
 */
public class YaFollowFail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Error, Ya sigues a este usuario!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YaFollowFail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
