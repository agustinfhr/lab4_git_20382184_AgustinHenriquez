...
/**
 * Una clase para representar la interfaz de un error en el register, el nombre de usuario ya se encuentra registrado 
 * 
 */
public class RegisterFailUserName extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();
    
    public RegisterFailUserName() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Error, nombre Ya Registrado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterFailUserName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
