...
/**
 * Una clase para representar la interfaz de un error en el post, la publicacion no se encuentra registrada
 * 
 */
public class PostNotFound extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostNotFound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
