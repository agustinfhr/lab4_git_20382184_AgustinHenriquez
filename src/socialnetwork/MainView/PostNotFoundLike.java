...
/**
 * Una clase para representar la interfaz de un error en el like, la publicacion a dar like no se encuentra registrada
 * 
 */
public class PostNotFoundLike extends javax.swing.JFrame {

    FondoPanel fondo = new FondoPanel();

    public PostNotFoundLike() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PostNotFoundLike.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
