...
/**
 * Una clase para representar la interfaz de un error en el login, el nombre de usuario no se encuentra registrado en la red social
 * 
 */
public class LoginNotFound extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Error, usuario no registrado!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginNotFound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
