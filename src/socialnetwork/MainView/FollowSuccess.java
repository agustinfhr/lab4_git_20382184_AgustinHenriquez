...
/**
 * Una clase para representar la interfaz de un follow realizado con exito
 * 
 */
public class FollowSuccess extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ahora sigues a este usuario!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FollowSuccess.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
